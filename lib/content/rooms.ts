...
export const roomTypes: RoomType[] = [
  {
    ...
    features: [
      {
        en: "King bed with premium linens",
        es: "Cama King con ropa de cama premium",
      },
      { en: "City & mountain views", es: "Vistas a la ciudad y montañas" },
      {
        en: "Costa Rican coffee station",
        es: "Estación de café costarricense",
      },
      {
        en: "Rain shower & local amenities",
        es: "Ducha tipo lluvia y amenidades locales",
      },
    ],
    gallery: [
      {
        ...
        alt: {
          en: "Signature King room interior",
          es: "Interior de la habitación Signature King",
        },
      },
        {
        type: "image",
        src: "/images/guest-room.jpg",
        alt: {
          en: "Signature King seating and window",
          es: "Sala y ventanal de la Signature King",
        },
      },
      {
        type: "image",
        src: "/images/room-signature.png",
        alt: {
          en: "Signature King seating and window",
          es: "Sala y ventanal de la Signature King",
        },
  ...
  },
  {
    ...
    tagline: {
      en: "Rest with a view of the game",
      es: "Descansa con vista al juego",
    },
    description: {
    ...
    features: [
      ...
      {
        en: "King or twin configuration",
        es: "Configuración King o dos camas",
      },
      {
        en: "Smart lighting & blackout drapes",
        es: "Iluminación inteligente y cortinas blackout",
      },
    ],
    gallery: [
      {
        type: "image",
        src: "/images/room-stadium-suite.png",
        alt: {
          en: "Stadium View room overlooking the pitch",
          es: "Habitación con vista a la cancha",
        },
      },
      {
        type: "image",
        src: "/images/guest-room.png",
        alt: {
          en: "Stadium View room interior",
          es: "Interior de la habitación con vista al estadio",
        },
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        en: "Wraparound corner windows",
        es: "Ventanales de esquina envolventes",
      },
    ...
    gallery: [
      {
        type: "image",
        src: "/images/room-corner.png",
        alt: {
          en: "Corner Suite living area",
          es: "Sala de la Suite de Esquina",
        },
      },
      {
        type: "image",
        src: "/images/guest-room.png",
        alt: {
          en: "Corner Suite bedroom",
          es: "Dormitorio de la Suite de Esquina",
        },
      },
    ],
  },
  {
    ...
    tagline: {
      en: "Comfort without compromise",
      es: "Comodidad sin concesiones",
    },
    description: {
    ...
    features: [
      {
        en: "Step-free, wheelchair-friendly layout",
        es: "Distribución sin desniveles y accesible",
      },
      {
        en: "Roll-in shower with grab bars",
        es: "Ducha de acceso rodado con barras de apoyo",
      },
      {
        en: "Lowered fixtures & controls",
        es: "Accesorios y controles a menor altura",
      },
    ...
    gallery: [
      {
        type: "image",
        src: "/images/guest-room.png",
        alt: { en: "Accessible King room", es: "Habitación King Accesible" },
      },
    ],
  },
];
